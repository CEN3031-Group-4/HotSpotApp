...
class Gaussian extends React.Component {
    ...
    render() {
        ...
        // 2. We need to make sure the inported variables all match//
        // 3. Need to create a function in App.js titled updateGaussian
        // (or whichever file will be Gaussian's immediate parent)
        ...
        const { stableValue, modelType, fireCloudTop, fireRadius } = this.props;
        const Qt = this.props.sourceAmount;
        var x = this.props.receptorDistance;
        var z = this.props.receptorHeight;
        var H = this.props.releaseHeight;
        var u = this.props.windSpeed;
